...
export async function addParticipant(huishoudboekId: string, participantUid: string): Promise<void> {
...
export function AddHuishoudboekje(huishoudboekje: HuishoudboekjeEntry)
{
    ...
    setDoc(newRef, boekje);
}

export async function AddHuishoudeboekjeParticipant(id: string, userId: string, participantEmail: string)
{
...
export async function GetHuishoudboekjeById(id: string, userId: string) : Promise<Huishoudboekje>
{
...
export async function UpdateHuishoudboekje(huishoudboekje: Huishoudboekje)
{
    ...
    const boekje = GetHuishoudboekjeById(huishoudboekje.id, huishoudboekje.ownerId);
    if (!boekje)
    {
        throw new Error("Huishoudboekje niet gevonden");
    }
