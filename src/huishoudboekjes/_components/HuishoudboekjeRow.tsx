...
export function HuishoudboekjeRow({ entry }: { entry: Huishoudboekje }) {
  const { user } = useAuth();
  ...
  const aanpassen = (huishoudboekje: Huishoudboekje) => {
    navigate("/huishoudboekjes/aanpassen/" + huishoudboekje.id);
  };
