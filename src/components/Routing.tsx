  ...
  return (
    <Routes>
      ...
      <Route element={<ProtectedRoute />}>
        ...
        <Route
          path="/huishoudboekjes"
          element={<OverviewHuishoudboekjePage />}
        />
        <Route
          path="/huishoudboekjes/gearchiveerd"
          element={<OverviewGearchiveerdeHuishoudboekjePage />}
        />
        <Route
          path="/huishoudboekjes/toevoegen"
          element={<AddHuishoudboekjePage />}
        />
        <Route
          path="/huishoudboekjes/aanpassen/:id"
          element={<EditHuishoudboekjePage />}
        />
        <Route
          path="/huishoudboekjes/details/:id"
          element={<DetailHuishoudboekjePage />}
        />
      </Route>
    </Routes>
  );
